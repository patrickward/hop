...
type TestConfig struct {
	...
	API struct {
		...
		RetryDelay  hopconfig.Duration `json:"retry_delay" env:"API_RETRY_DELAY" default:"5s"`
...
func TestConfigLoading(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			files: []string{"testdata/hopconfig.json"},
			env: map[string]string{
				"SERVER_PORT":     "8080",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Load config
			err := hopconfig.Load(cfg, tt.files...)
