...
import (
	...
	"github.com/patrickward/hop/hopview"
	"github.com/patrickward/hop/hopview/testdata/source1"
	"github.com/patrickward/hop/hopview/testdata/source2"
)
...
func TestTemplateManager(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			tm, err := hopview.NewTemplateManager(
				tt.sources,
				hopview.TemplateManagerOptions{
					Extension: ".gtml",
					Funcs:     funcMap,
					Logger:    logger,
				})
